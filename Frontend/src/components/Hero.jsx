          ...
          <div className="pl-0 xs:w-full xl:w-[60%] sm:pl-[8%]">
            ...
            <div className="resume mt-[28px]">
              <div className="flex flex-col gap-2 sm:flex-row">
                <a
                  href="/certificates/Keshav Nagare - Final Resume.pdf"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="border-[1px] rounded-[8px] p-[10px] xs:btnsize flex justify-center items-center transition-all duration-200"
                  download
                >
                  <FaRegFileLines className="mr-[2px]" size={20} /> Resume
                </a>

                <Link className="font-NavTitle font-[400]" to={`/contact`}>
                  <button className="w-full border-[1px] rounded-[8px] p-[10px] xs:btnsize resume bg-[#07bae2d9] hover:bg-[#01bde7b2]">
                    Contact me
                  </button>
                </Link>
              </div>
            ...
            <div className="medialinks flex mt-[42px] gap-[14px]">
              <a href="https://www.instagram.com/keshav.3539/" target="_blank">
                <img className="w-[52px]" src={Insta} alt="Instagram" />
              </a>
              <a
                href="https://www.linkedin.com/in/keshav-nagare/"
                target="_blank"
              >
                <img className="w-[52px]" src={Linkdin} alt="linkedin" />
              </a>
              <a href="https://github.com/keshavNagare/" target="_blank">
                <img className="w-[52px]" src={Github} alt="github" />
              </a>
              <a href="mailto:keshavnagare102@gmail.com">
                <img
                  className="w-[52px] contrast-[120%]"
                  src={Email}
                  alt="email"
                />
              </a>
