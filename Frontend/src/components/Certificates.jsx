...
const Certificates = () => {
  ...
  return (
    ...
    <div className="About pb-[0px] sm:pb-[60px]">
      ...
      <h1 className="page-title text-[1.5rem] sm:text-[1.6rem] md:text-[1.85rem]">My Certificates</h1>
      <div className="certificates-grid">
        {certificateList.map((cert, index) => (
          <div className="card" key={index}>
            <h2 className="text-[1rem] sm:text-[1.2rem] md:text-[1.2rem]"><b>{cert.title}</b></h2>
            <hr /><br />
            <p className="text-[0.8rem] sm:text-[1.1rem] md:text-[1.2rem]"><strong>Issuer:</strong> {cert.issuer}</p>
            <p className="text-[0.8rem] sm:text-[1.1rem] md:text-[1.2rem]"><strong>Date:</strong> {cert.date}</p>
